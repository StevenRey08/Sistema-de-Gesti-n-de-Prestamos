  ...
  seed: async (req, res) => {
    try {
      const result = await prisma.$transaction(async (tx) => {
        ...
        const herramientas = [
          { codigo: 'MULT-001', nombre: 'Multímetro Digital', categoria_id: categorias[0].id, cantidad_total: 15, cantidad_disponible: 12 },
          { codigo: 'OSC-001', nombre: 'Osciloscopio', categoria_id: categorias[0].id, cantidad_total: 5, cantidad_disponible: 4 },
          { codigo: 'CAL-001', nombre: 'Calibrador Vernier', categoria_id: categorias[0].id, cantidad_total: 20, cantidad_disponible: 18 },
          { codigo: 'PIN-001', nombre: 'Pinzas de Corte', categoria_id: categorias[1].id, cantidad_total: 25, cantidad_disponible: 22 },
          { codigo: 'COR-001', nombre: 'Cortador Lateral', categoria_id: categorias[1].id, cantidad_total: 20, cantidad_disponible: 19 },
          { codigo: 'SIE-001', nombre: 'Sierra para Metal', categoria_id: categorias[1].id, cantidad_total: 10, cantidad_disponible: 9 },
          { codigo: 'TOR-001', nombre: 'Juego de Destornilladores', categoria_id: categorias[2].id, cantidad_total: 15, cantidad_disponible: 14 },
          { codigo: 'LLA-001', nombre: 'Llave Inglesa', categoria_id: categorias[2].id, cantidad_total: 10, cantidad_disponible: 10 },
          { codigo: 'PRE-001', nombre: 'Prensa de Mesa', categoria_id: categorias[2].id, cantidad_total: 3, cantidad_disponible: 3 },
          { codigo: 'SOL-001', nombre: 'Cautín de Soldar', categoria_id: categorias[3].id, cantidad_total: 12, cantidad_disponible: 10 },
          { codigo: 'PRO-001', nombre: 'Protoboard', categoria_id: categorias[3].id, cantidad_total: 20, cantidad_disponible: 18 },
          { codigo: 'FUE-001', nombre: 'Fuente de Poder Variable', categoria_id: categorias[3].id, cantidad_total: 6, cantidad_disponible: 5 },
          { codigo: 'CAS-001', nombre: 'Casco de Seguridad', categoria_id: categorias[4].id, cantidad_total: 20, cantidad_disponible: 20 },
          { codigo: 'GAF-001', nombre: 'Gafas de Protección', categoria_id: categorias[4].id, cantidad_total: 30, cantidad_disponible: 28 },
          { codigo: 'GUA-001', nombre: 'Guantes de Trabajo', categoria_id: categorias[4].id, cantidad_total: 25, cantidad_disponible: 23 },
          { codigo: 'PIN-002', nombre: 'Pinzas de Punta', categoria_id: categorias[1].id, cantidad_total: 18, cantidad_disponible: 16 },
          { codigo: 'DES-001', nombre: 'Desoldador', categoria_id: categorias[3].id, cantidad_total: 8, cantidad_disponible: 7 },
          { codigo: 'LIM-001', nombre: 'Lima Plana', categoria_id: categorias[1].id, cantidad_total: 15, cantidad_disponible: 14 },
        ];
